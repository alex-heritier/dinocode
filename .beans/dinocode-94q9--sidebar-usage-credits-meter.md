---
# dinocode-94q9
title: Sidebar usage + credits meter
status: todo
type: feature
priority: low
...
Show account rate-limit and credit usage in the sidebar, matching CodexMonitor's provider meter. Audit source: docs/codex-monitor-parity-audit.md.

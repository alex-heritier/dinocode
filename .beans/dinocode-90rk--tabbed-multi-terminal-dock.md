---
# dinocode-90rk
title: Tabbed multi-terminal dock
status: todo
type: feature
priority: low
...
Extend ThreadTerminalDrawer to support multiple named terminal tabs per thread. Audit source: docs/codex-monitor-parity-audit.md.
